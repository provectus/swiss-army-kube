...
To configure your project cluster for deployment, just [include modules](https://github.com/Evanto/qna/wiki/SAK-Modules) that you need and [set variables](https://github.com/Evanto/qna/wiki/SAK-Configure-Deployment-in-example.tfvars) in the `.tfvars` file before deploying your EKS cluster with Terraform commands. 
